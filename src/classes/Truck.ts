...
class Truck extends Vehicle implements AbleToTow{
  ...
  tow(vehicle: Truck | Motorbike | Car): void {
    ...
    const vehicleMake = 'make' in vehicle ? vehicle.make : 'Unknown Make';
    const vehicleModel = 'model' in vehicle ? vehicle.model : 'Unknown Model';
    ...
    if ('weight' in vehicle) {
      ...
      console.log(`The weight of the ${vehicleMake} ${vehicleModel} is unknown.`);
    }
  }
