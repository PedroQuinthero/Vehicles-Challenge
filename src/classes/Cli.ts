    ...
    inquirer
      ...
      .then((answers) => {
        ...
        const truck = new Truck(
          ...
          parseInt(answers.topSpeed),
          [],
          parseInt(answers.towingCapacity) // Specific property for Truck
        );
    ...
    inquirer
      ...
      .then((answers) => {
        ...
        if (selectedVehicle.vin === truck.vin) {
          ...
          console.log(
            `The truck successfully towed the vehicle: ${selectedVehicle.make} ${selectedVehicle.model}`
          );
        }
        this.performActions();
      });
      ...
      .then((answers) => {
        ...
        if (answers.action === 'Print details') {
          ...
          if (truck && truck instanceof Truck) {
            ...
            console.log("Only trucks can tow vehicles. Please select another action.");
          }
          ...
          if (motorbike && motorbike instanceof Motorbike) {
